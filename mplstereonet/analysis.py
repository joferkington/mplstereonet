...
def calculate_eigenvector(*args, **kwargs):
    ...
    *args : A variable number of sequences of measurements. By default, this
    ...
    Returns
    -------
    One list, with 3 rows, each corresponding to the strike and dip of a plane.
    The 3 intersections of the planes and their poles are the 3 eigenvectors.
    ...
    vec = []
    for x in range(3):
        vec.append(_sd_of_eigenvector(args, vec=x, **kwargs))
    return vec
